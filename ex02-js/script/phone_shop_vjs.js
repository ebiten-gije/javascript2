function testAttributes(){
    ...
    let subIamge = document.getElementsByClassName('sub-image');
    console.log(".sub-image: ", subIamge);
    //  루프를 돌면서 속성 변경;
    for(let i = 0; i < subIamge.length; i++){
        subIamge[i].setAttribute("title",
            `제품: ${subIamge[i].getAttribute('title')}`)
        console.log();
    }
